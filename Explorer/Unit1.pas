...
uses
  ...
  ClipBrd, ShlObj, ActiveX, ComObj, Vcl.StdCtrls, Vcl.ExtCtrls ;
...
begin
  CreateLink(Edit1.Text,
            ExtractFilePath(Application.ExeName) + ExtractFileName(Edit1.Text) + '.lnk','','');
end;
...
begin
  ...
  case Panel.Index of
    ...
    0: begin
      // image zeichnen
      ImageList5.Draw(StatusBar.Canvas, Rect.Left, Rect.Top, 0);
      // text dazuschreiben
      StatusBar.Canvas.TextOut(Rect.Left + ImageList5.Width  , Rect.Top, Panel.Text);
    end;

    1: begin
      // image zeichnen
      ImageList5.Draw(StatusBar.Canvas, Rect.Left, Rect.Top, 1);
      // text dazuschreiben
      StatusBar.Canvas.TextOut(Rect.Left + ImageList5.Width  , Rect.Top, Panel.Text);
    end;
